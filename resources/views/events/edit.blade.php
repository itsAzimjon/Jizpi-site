            ...
            <form action="{{ route('events.update', ['event' => $event->id])}}" method="POST" enctype="multipart/form-data">  
                        ...
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <select name="category_id" aria-label="Default select example" class="form-select">
                                    ...
                                    <option value="{{ $option->id }}" {{ $option->id == $event->category_id ? 'selected' : '' }}>
                                        {{ $option->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('Passport')border border-danger rounded-3 @enderror">
                                <textarea class="form-control"  type="text" name="description">{{ $event->description}}
                                </textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                            <input required class="form-control" type="text" id="welcome-title" name="title_en" value="{{ __($event->title, [], 'en')}}">
                                @error('title')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                        </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="@error('title')border border-danger rounded-3 @enderror">
                            <textarea class="form-control"  type="text" name="description_en">{{ __($event->description, [], 'en')}}
                            </textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                            <input required class="form-control" type="text" id="welcome-title" name="title_ru" value="{{ __($event->title, [], 'ru')}}">
                                @error('title')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                        </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="@error('title')border border-danger rounded-3 @enderror">
                            <textarea class="form-control"  type="text" name="description_ru">{{ __($event->description, [], 'ru')}}
                            </textarea>
                        </div>
                    </div>
                </div>
