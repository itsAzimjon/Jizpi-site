...
<div class="container">
    <div class="row allNews">
        ...
        @foreach ($events as $event)
            @php
                $currentMonth = \Carbon\Carbon::parse($event->created_at)->format('F Y');
            @endphp
