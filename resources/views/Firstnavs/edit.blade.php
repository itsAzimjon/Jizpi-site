...
<div class="container">
    <div class="row">
        <div class="col my-5">
            <form action="{{ route('secondnavs.update', ['secondnav' => $secondnav->id ]) }}" method="POST" enctype="multipart/form-data"> 
                @method('PUT')   
                @csrf
                @if($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" id="welcome-title" name="title" value="{{ $secondnav->title }}">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" id="welcome-title" name="title_en" value="{{ __($secondnav->title , [], 'en')}}">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" id="welcome-title" name="title_ru" value="{{ __($secondnav->title , [], 'ru')}}">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('title')border border-danger rounded-3 @enderror">
                                <textarea class="form-control"  type="text" name="description">{{ $secondnav->description }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('title')border border-danger rounded-3 @enderror">
                                <textarea class="form-control"  type="text" name="description_en">{{ __($secondnav->description, [], 'en')}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('title')border border-danger rounded-3 @enderror">
                                <textarea class="form-control"  type="text" name="description_ru">{{ __($secondnav->description, [], 'ru')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
