...
<div class="container">
    <div class="row">
        <div class="col my-5">
            <form action="{{ route('secondnavs.store') }}" method="POST" enctype="multipart/form-data">    
                @csrf
                @if($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <select name="firstnav_id" aria-label="Default select example" class="form-select">
                                    @foreach($navs as $option)
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" id="welcome-title" name="title_en">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" id="welcome-title" name="title_ru">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
