...
class IndicatorSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Indicator::create(['title' => 'O‘qituvchilar', 'number' => 450, 'image' => '/img/teacher1.png']);
        Indicator::create(['title' => 'Magistrlar', 'number' => 260, 'image' => '/img/graduated.png']);
        ...
        Indicator::create(['title' => 'Xorijiy talabalar', 'number' => 10, 'image' => '/img/Group1.png']);
    }
}
